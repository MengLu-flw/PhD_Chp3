...
#--get coordinates--#
pop <- read.xlsx("Verbascum.xlsx")


#--plot points--#
#--set your own colour--#
col = c("Verbascum thapsus" = "#AA895A", "Verbascum nigrum" = "#7A1751")
...
pdffn = "Verbascum_sampling_map.pdf"
...
pdffn = "Verbascum_sampling_map_noLABs.pdf"
pdf(pdffn, width=5, height=7)
